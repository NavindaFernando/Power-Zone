...
public class OrderController {
    ...
    public boolean placeOrder(Order order){
        ...
        try {
            ...
            stm.setObject(2,order.getMemberId());
    ...
    private boolean saveOrderDetails(String orderId, ArrayList<ItemDetail> items) throws SQLException, ClassNotFoundException {
